    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 ml-5">
                <img src="img/product6.webp" style="width: 75%;">
            </div>
            <div class="col-sm-4">
                
                
              <h2>Jackhammer Co. Ramie Noragi Outer</h2>
              <h3 style="color: red;">IDR Rp339.000</h3>
              ...
              <p>Outer<br>
                Desain trendy<br>
                V-neckline, side pockets, dan front button opening<br>
                Material : Cotton
                </p><br/><br/>
...
<footer class="page-footer font-small mdb-color lighten-3 pt-4 bg-light">
  ...
  <div class="footer-copyright text-center py-3"><a href="index.html" class="text-secondary"> © STOCKROOM 2020</a></div>
