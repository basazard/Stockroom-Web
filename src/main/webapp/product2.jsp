    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 ml-5">
                <img src="img/product2.webp" style="width: 75%;">
            </div>
            <div class="col-sm-4">
                
                
              <h2>Oldblue Co Work - Spectrum Neps Chambray Shirt</h2>
              <h3 style="color: red;">IDR Rp.850.000</h3>
              ...
              <p>Long sleeve shirt<br>
                Casual design<br>
                Pointed collar, front button opening<br>
                Front pocket and button of cloth</p><br/><br/>
