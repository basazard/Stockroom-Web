    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 ml-5">
                <img src="img/product4.webp" style="width: 75%;">
            </div>
            <div class="col-sm-4">
                
                
              <h2>Oldblue Co. 7.75 Cut - 18 Oz Over-Slub Selvedge Atlantic</h2>
              <h3 style="color: red;">IDR Rp1.850.000</h3>
              ...
              <p>Long pants<br>
                Casual design<br>
                Front zipper and button opening, front and back pockets<br>
                Belt loops details<br>
                </p><br/><br/>
